...
async function importData() {
  try {
    ...
    const promises = [];
    promises.push(axios.get('https://sanity-nextjs-rouge.vercel.app/api/foods'));
    promises.push(axios.get('https://sanity-nextjs-rouge.vercel.app/api/chefs'));

    const [foodsResponse, chefsResponse] = await Promise.all(promises);
